...
class NinjaTableClass
{
    ...
    private function load_dependencies()
    {
        ...
        require_once plugin_dir_path(dirname(__FILE__)) . 'admin/table-builder/NinjaTableBuilder.php';
    ...
    private function define_admin_hooks()
    {
        ...
        $plugin_table_builder = new \NinjaTableBuilder();
        ...
        $this->loader->add_action('init', $this, 'remindMeLater');
        ...
        $this->loader->add_action('wp_ajax_ninja_tables_builder_ajax_actions',
            $plugin_table_builder,
            'table_builder_ajax_routes'
        );
...
//        });
    ...
    private function define_public_hooks()
    {
        ...
        $this->loader->add_action('wp_loaded', $demoPage, 'handleExteriorPages');
        $this->loader->add_action('wp_loaded', $demoPage, 'ninjaTableBuilderPreview');
    }
    ...
    {
        if (isset($_GET['action']) && sanitize_text_field($_GET['action']) === 'remindMeLater') {
            setcookie(
                "nt_review_notice",
                $this->version,
                time() + (60 * 60 * 24 * 30)
